...
<div class="x-two">
  <div class="x-two-col">
    ...
    <a class="x-two-go" :href="withBase('/cx/matrix')">The commissioning matrix →</a>
  </div>
  <div class="x-two-col">
    ...
    <a class="x-two-go" :href="withBase('/work/workflow-progress')">Workflow progress →</a>
  </div>
</div>
...
<div class="x-roles">
  <a class="x-role" :href="withBase('/cx/')">
  ...
  <a class="x-role" :href="withBase('/work/')">
  ...
  <a class="x-role" :href="withBase('/build/')">
  ...
  <a class="x-role" :href="withBase('/setup/')">
  ...
  <a class="x-role" :href="withBase('/admin/')">
  ...
  <a class="x-role" :href="withBase('/getting-started/quick-start')">
...
<div class="x-concepts">
  <a class="x-concept" :href="withBase('/modules/')">
  ...
  <a class="x-concept" :href="withBase('/modules/record-lifecycle')">
  ...
  <a class="x-concept" :href="withBase('/projects/')">
  ...
  <a class="x-concept" :href="withBase('/masters/')">
  ...
  <a class="x-concept" :href="withBase('/cx/matrix')">
  ...
  <a class="x-concept" :href="withBase('/concepts/permissions')">
...
<div class="x-more">
  <a class="x-m" :href="withBase('/analytics/dashboard-builder')"><strong>Dashboard builder</strong><span>Widgets, data sets and the dashboards people land on.</span></a>
  <a class="x-m" :href="withBase('/admin/projects')"><strong>Creating a project</strong><span>The form, the schedule, and the four tabs on an existing project.</span></a>
  <a class="x-m" :href="withBase('/menu/')"><strong>Menu configuration</strong><span>What appears in the sidebar, for whom, and in what order.</span></a>
  <a class="x-m" :href="withBase('/ai/')"><strong>AI</strong><span>Ask questions of your data and read what it makes of a record.</span></a>
  <a class="x-m" :href="withBase('/integrations/')"><strong>Integrations</strong><span>Call another system on a change, or be called by one.</span></a>
  <a class="x-m" :href="withBase('/account/signing-in')"><strong>Your account</strong><span>Signing in, switching tenant, date format and theme.</span></a>
  <a class="x-m" :href="withBase('/architecture/')"><strong>Architecture</strong><span>For people who build Exto — its layers and how a feature is composed.</span></a>
</div>
